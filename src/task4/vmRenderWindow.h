...
public slots:
	...
	void onRightButton(vtkObject* obj,unsigned long,void* client_data,void*,vtkCommand* command);
...
private:
	...
	vtkSmartPointer<vtkCaptionActor2D> m_tag;
...
private:
	...
	int	__loadGeometry(double* boxExtent);
};
