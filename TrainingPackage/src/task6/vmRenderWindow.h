...
private:
	...
	std::vector< vtkTgDataReader* > m_pstlineModels;
	vtkTgDataReader* m_pstlineModel;

	std::vector< vtkSmartPointer<vtkRenderer> > m_renders;
	...
	std::vector< vtkSmartPointer<vtkActor> > m_haloactors;
	...
	std::vector< std::string > m_fnGeometrys;
