...
enum {
	UT_TASKBOX = 0,
	UT_HELPTEXT,
	UT_ANSTEXT // show answer prompt at the top of the screen
};
...
public:
	...
	bool& prompt() { return m_bPrompt; }
	bool& hintBtnText() { return m_bHintBtnText; }
...
private:
	...
	bool			m_bPrompt; // if prompt answer when clicking an option button
	bool			m_bHintBtnText; // show key index or key button text
private:
	int _calcBtnLayout();
};
